  ...
  navigate('/payments', {
    state: {
      ...
      preselectedStudentId: student._id
    }
  });
};
                          ...
                          <tr key={student._id} className="group hover:bg-blue-50/30 transition-all cursor-pointer" onClick={() => { setSelectedStudent(student); setViewModalTab('profile'); }}>
                            ...
                            <td className="px-6 py-4 text-center" onClick={(e) => e.stopPropagation()}>
                              <button
                                ...
                                className="inline-flex items-center gap-2 rounded-lg bg-indigo-50 px-3 py-1.5 text-xs font-semibold text-indigo-700 hover:bg-indigo-100 transition-all"
                              >
            ...
            >
              ...
              <div className="border-b border-gray-100 bg-gray-50/50 px-6 flex gap-4 sticky top-[76px]">
                <button
                  ...
                  className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${viewModalTab === 'profile'
                ...
                <button
                  ...
                  className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${viewModalTab === 'academic'
                      ? 'text-blue-600 border-blue-600'
                      : 'text-gray-600 border-transparent hover:text-gray-900'
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${viewModalTab === 'contact'
                      ? 'text-blue-600 border-blue-600'
                      : 'text-gray-600 border-transparent hover:text-gray-900'
                    }`}
                >
              ...
              {/* Modal Actions - with Add Payment button */}
              <div className="border-t border-gray-100 bg-gray-50/50 p-6 flex gap-3 justify-end sticky bottom-0">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition-all"
                >
